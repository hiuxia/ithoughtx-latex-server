# iThoughts Latex server docker based on texlive/texlive 
...
```sh
docker build -t ithoughts-latex . 
```
...
## Chinese support
The Texlive/texlive base image has already ctex related packages installed.
add Chinse support in the string 
...
\geometry{paperheight=8cm, paperwidth=10cm}
\geometry{hcentering}
